...
double p0, p, e, e0, m, mR, dm, A, B=1.0, dB, BR, Bfactor, m1, m2, m3, m4, p1, p2, p3, p4, B1, B2, B3, B4, power,Ibar,I=0.0,J,DDf,Df=0.0,f=1.0;
...
printf("Please enter the filename of the equation of state: ");
scanf("%s",filename);
...
for(times=3.0;times>=3.0;times=times-0.5)
{
  ...
  r=r0;
  printf("Please enter a central density (1.0E18 for example): ");
  scanf("%lf",&e0);
...
fprintf(outf,"M/Msun      R/1000km    frequency/kHz damping time/s\n");
